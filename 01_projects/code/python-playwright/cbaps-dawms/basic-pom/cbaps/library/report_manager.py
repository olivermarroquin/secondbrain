"""
ReportManager: HTML report generation for CBAPS automation
...
class ReportManager:
    ...
    def setup_report(self):
        ...
        try:
            ...
            self.report_path = f"target/report/cbaps-automation-report-{timestamp}.html"
...
# pytest --html=target/report/cbaps-report.html --self-contained-html
