"""
Pytest configuration for DAWMS tests
Defines fixtures and hooks used across all DAWMS test modules
"""
...
def pytest_html_report_title(report):
    ...
    report.title = "DAWMS Automation Test Report"
