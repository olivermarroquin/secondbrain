...
# Create EnhancedPlaywrightManager
cat > src/main/java/com/playwright/cbaps/library/EnhancedPlaywrightManager.java << 'EOFPM'
...
# Create Models
cat > src/main/java/com/playwright/cbaps/models/RequisitionData.java << 'EOFMODEL'
...
cat > src/main/java/com/playwright/cbaps/models/FundingLineData.java << 'EOFMODEL2'
package com.playwright.cbaps.models;
...
echo "✅ Step 1: EnhancedPlaywrightManager and Models created"
