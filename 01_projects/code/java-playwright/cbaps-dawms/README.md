...
the files present in the project level are files set up in this tree directory format. use that folder structure format for the file structure and separate them so that one is focused on CBAPS and the other is focused on DAWMS *each should have new pages and test scripts based on the files talked about in this file. so therefore, look inside this README.md file and see what exactly I'm looking for, below is some code that you can litterally copy and paste

/Users/olivermarroquin/secondbrain/01_projects/code/java-playwright/java-playwright-cbaps-dawms/src/UIAutomation/src/test/java/com
├── cbaps (with files tailored to this system rather than mortgagecalculator)
│   ├── libraries and various other tests i want tailored to CBAPS and DAWMS if possible
│   │   ├── library
│   │   │   ├── Base.java
│   │   │   ├── ExcelManager.java
...
│   │   └── tests
│   │       ├── Base64ImageCaptureTests.java
│   │       ├── CertificateErrorTests.java
│   │       ├── DataDrivenTestsNet.java
│   │       ├── DataDrivenTestsOrg.java
│   │       ├── MortgageCalculatorOrgTest.java
│   │       └── PurchaseAutomation.java
│   └── page-object-model-example
│       ├── pages
│       │   ├── CheckOutPage.java
│       │   ├── HomePage.java
│       │   ├── ProceedToCheckoutPage.java
│       │   ├── ProductTypePage.java
│       │   ├── ProductTypes.java
│       │   └── SearchCourseResultPage.java
│       └── tests
│           └── BuyACourseTestScript.java
└── playwright.zip

8 directories, 18 files

├── dawms (with files tailored to this system rather than mortgagecalculator)
│   ├── libraries and various other tests i want tailored to CBAPS and DAWMS if possible
│   │   ├── library
│   │   │   ├── Base.java
│   │   │   ├── ExcelManager.java
...
- Ensure class names, file names, and package declarations stay consistent (using the page object and test names and all file names that exist in this README.md file)
...
- Assume the existing UIAutomation structure and the one in this README.md file is correct.
- Do not invent new pages or tests beyond the workflows described here in this file.
