...
public class ExtentReportManager {
	...
	public static ExtentReports getInstance() {
		...
		if (extent == null) {
			...
			String reportPath = "target/report/dawms-extent-report-" + timeStamp + ".html";
			...
			sparkReporter.config().setReportName("DAWMS Automation Test Results");
			sparkReporter.config().setDocumentTitle("DAWMS Test Report");
			
			extent = new ExtentReports();
			extent.attachReporter(sparkReporter);
			extent.setSystemInfo("Automation Developer", "QA Team");
			extent.setSystemInfo("Environment", "QA/Test");
			extent.setSystemInfo("Application", "DAWMS");
		}		
		return extent;
	}
}
